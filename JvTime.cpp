...
JvTime::JvTime(int year, int month, int day, int hour, int minute, int second) {
    this->year = year;
    this->month = month;
    this->day = day;
    this->hour = hour;
...
void JvTime::setTime(int year, int month, int day, int hour, int minute, int second) {
    this->year = year;
    this->month = month;
    this->day = day;
    this->hour = hour;
...
std::string JvTime::get12HourTimeString() {
    int hour12 = hour % 12;
    if (hour12 == 0) {
        hour12 = 12;
    }
    ...
    char buffer[16];
    snprintf(buffer, sizeof(buffer), "%02d:%02d %s", hour12, minute, am_pm.c_str());
